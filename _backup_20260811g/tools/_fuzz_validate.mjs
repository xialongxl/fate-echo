...
console.log('== G. 合法数据回归（53 技能）==');
{
  ...
  t('G3 效果类型全集 = 13 种（含 ap_recover；mp_recover 已删）', EFFECT_TYPES.length === 13 && EFFECT_TYPES.includes('ap_recover') && !EFFECT_TYPES.includes('mp_recover') && DOMAIN_TYPES.length === 5);
}
