...
export const ENEMIES_DB = [
  ...
  { id: 'e01', name: '史莱姆', tier: 'normal', baseHp: 45, baseAtk: 6, baseDef: 4, skills: ['s01'], desc: '黏糊糊的软体生物，只会弹跳撞击。' },
  { id: 'e02', name: '丛林之狼', tier: 'normal', baseHp: 55, baseAtk: 6, baseDef: 5, skills: ['s03', 's17'], desc: '群居的掠食者，星尘咏叹与神圣惩击。' },
  { id: 'e03', name: '骷髅士兵', tier: 'normal', baseHp: 60, baseAtk: 6, baseDef: 4, skills: ['s01', 's17'], desc: '不死的骸骨，挥剑时夹杂神圣惩击。' },
  { id: 'e04', name: '哥布林法师', tier: 'normal', baseHp: 45, baseAtk: 6, baseDef: 10, skills: ['s03', 's10'], desc: '偷学的法术，星尘咏叹与月火术。' },
  { id: 'e05', name: '石像鬼', tier: 'normal', baseHp: 95, baseAtk: 6, baseDef: 6, skills: ['s06', 's02'], desc: '坚硬的雕像守卫，冰霜与光辉护甲护体。' },
  { id: 'e06', name: '腐化树精', tier: 'normal', baseHp: 70, baseAtk: 6, baseDef: 6, skills: ['s04', 's19'], desc: '被腐蚀的古树，诅咒与再生并存。' },
  // ---- 精英（数值初稿 ⚠️） ----
  { id: 'e07', name: '暗影刺客', tier: 'elite', baseHp: 120, baseAtk: 11, baseDef: 8, skills: ['s25', 's26', 's18'], desc: '来去无踪的杀手：混沌箭、暗影裂隙与死亡标记。' },
  { id: 'e08', name: '冰霜巨人', tier: 'elite', baseHp: 190, baseAtk: 12, baseDef: 8, enragePct: 0.5, skills: ['s06', 's27', 's32', 's26', 's40'], desc: '半血狂暴，绝境献祭（自爆）：龙破斩与灵魂献祭。' },
  { id: 'e09', name: '瘟疫祭司', tier: 'elite', baseHp: 125, baseAtk: 9, baseDef: 12, dotImmune: true, skills: ['s04', 's36', 's19', 's07'], desc: '免疫持续伤害：痛苦诅咒、灾厄降临，靠黑暗契约续力。' },
  { id: 'e10', name: '虚空猎手', tier: 'elite', baseHp: 135, baseAtk: 10, baseDef: 10, skills: ['s08', 's20', 'e10_vamp', 's30'], desc: '噬咬吸取生命：虚空箭、血晶爆发与虚空噬咬。' },
  // ---- Boss（数值初稿 ⚠️） ----
  { id: 'e11', name: '深渊领主', tier: 'boss', baseHp: 330, baseAtk: 14, baseDef: 14, enragePct: 0.5, skills: ['s09', 's25', 's40', 's16', 's48'], desc: '半血狂暴，绝境献祭，展开虚空领域。' },
  { id: 'e12', name: '时空支配者', tier: 'boss', baseHp: 310, baseAtk: 13, baseDef: 16, enragePct: 0.5, skills: ['s39', 's44', 's46', 's30', 's50'], desc: '扭曲时空：终焉咏叹调、法则解构与烈焰领域。' },
];

// 内联定制技能（效果数据同源：复用 EFFECT_TYPES，validateSkillsDB 契约约束）
const CUSTOM_SKILLS = {
  // 虚空噬咬：1.6 倍伤害 + 恢复 150% 攻击力生命（吸血机制）
  e10_vamp: { id: 'e10_vamp', name: '虚空噬咬', reqLv: 1, type: 'gcd', cd: 0, cost: 15, dmgMult: 1.6, priority: 12, effects: [{ type: 'heal', val: 1.5 }] },
};
