...
console.log('== I. 回合结算与状态防御（护盾 NaN / dot 缺 source / maxHp·maxMp 异常 / vuln val=0）==');
{
  ...
  executeSkillEffects(ctx, new Skill({ id: 'i9', name: '无效易伤', reqLv: 1, type: 'debuff', cd: 0, cost: 0, dmgMult: 0, effects: [{ type: 'vuln', val: 0, dur: 4 }] }), s9, t9);
  ...
  executeSkillEffects(ctx, new Skill({ id: 'i10', name: 'NaN 易伤', reqLv: 1, type: 'debuff', cd: 0, cost: 0, dmgMult: 0, effects: [{ type: 'vuln', val: NaN, dur: 4 }] }), s10, t10);
