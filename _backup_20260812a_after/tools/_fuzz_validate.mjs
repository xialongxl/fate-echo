...
console.log('== G. 合法数据回归（53 技能）==');
{
  ...
  t('G3 效果类型全集 = 18 种（2026-08-12 敌人技能从零重做 +6）', EFFECT_TYPES.length === 18 && EFFECT_TYPES.includes('ap_recover') && EFFECT_TYPES.includes('lost_hp_dmg') && EFFECT_TYPES.includes('multi_hit') && DOMAIN_TYPES.length === 5);
}
