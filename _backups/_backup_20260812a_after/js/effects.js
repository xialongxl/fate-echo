...
export const EFFECT_HANDLERS = {
  ...
  atk_down(ctx, target, source, e) { applyStatBuff(target, { ...e, stat: 'atk_down_pct' }, ctx); },
  haste_down(ctx, target, source, e) { applyStatBuff(target, { ...e, stat: 'haste_down_pct' }, ctx); },
  heal_cut(ctx, target, source, e) { applyStatBuff(target, { ...e, stat: 'heal_cut_pct' }, ctx); },
