...
export const ENEMY_SKILLS = {
  // ---- 普通 ----
  en_撞击: { id: 'en_撞击', name: '弹跳撞击', reqLv: 1, type: 'main', dmgMult: 1.0, priority: 1, desc: '[主技能] 弹跳撞击，造成{dmgMult}%攻击力伤害。' },
  en_撕裂: { id: 'en_撕裂', name: '利爪撕裂', reqLv: 1, type: 'main', dmgMult: 1.8, priority: 5, desc: '[主技能] 利爪撕裂，造成{dmgMult}%攻击力伤害。' },
  en_圣击: { id: 'en_圣击', name: '骸骨圣击', reqLv: 1, type: 'main', dmgMult: 1.2, priority: 2, desc: '[主技能] 骸骨圣击，造成{dmgMult}%攻击力伤害。' },
  en_月灼: { id: 'en_月灼', name: '幽月灼烧', reqLv: 1, type: 'dot', dmgMult: 1.0, effects: [{ type: 'dot', dur: 4, dps: 1.0, stateName: '灼烧', stateEmoji: '🔥' }], priority: 8, desc: '[DoT] 造成{dmgMult}%攻击力伤害并灼烧4层。' },
  en_冰封: { id: 'en_冰封', name: '冰霜爪击', reqLv: 1, type: 'main', dmgMult: 2.2, priority: 6, desc: '[主技能] 冰霜爪击，造成{dmgMult}%攻击力伤害。' },
  en_石肤: { id: 'en_石肤', name: '硬化石肤', reqLv: 1, type: 'buff', dmgMult: 0, effects: [{ type: 'buff', stat: 'versa', val: 10, dur: 6 }], priority: 9, desc: '[Buff] 提升共鸣10%，持续6层。' },
  en_腐毒: { id: 'en_腐毒', name: '腐化毒液', reqLv: 1, type: 'dot', dmgMult: 0.5, effects: [{ type: 'dot', dur: 5, dps: 0.8, stateName: '恶咒', stateEmoji: '☠️' }], priority: 8, desc: '[DoT] 造成{dmgMult}%攻击力伤害并腐蚀5层。' },
  en_再生: { id: 'en_再生', name: '腐木再生', reqLv: 1, type: 'buff', dmgMult: 0, effects: [{ type: 'hot', pct: 0.03, dur: 6 }], priority: 12, desc: '[治疗] 每层恢复3%最大生命。' }, // hot pct 0.03 = 3%/层（desc 硬编码，不用 {dur} 模板——dur=6 是层数非百分比）
  // ---- 精英 ----
  en_混沌箭: { id: 'en_混沌箭', name: '混沌箭雨', reqLv: 1, type: 'main', dmgMult: 6.5, priority: 7, desc: '[主技能] 混沌箭雨，造成{dmgMult}%攻击力伤害。' },
  en_裂隙: { id: 'en_裂隙', name: '暗影裂隙', reqLv: 1, type: 'instant', dmgMult: 4.5, priority: 11, desc: '[瞬发] 暗影裂隙，造成{dmgMult}%攻击力伤害。' },
  en_标记: { id: 'en_标记', name: '死亡标记', reqLv: 1, type: 'debuff', dmgMult: 0, effects: [{ type: 'vuln', val: 1.2, dur: 4 }], priority: 15, desc: '[Debuff] 死亡标记：受击伤害提高4层。' },
  en_寒枪: { id: 'en_寒枪', name: '寒冰长枪', reqLv: 1, type: 'main', dmgMult: 1.8, priority: 4, desc: '[主技能] 寒冰长枪，造成{dmgMult}%攻击力伤害。' },
  en_龙破: { id: 'en_龙破', name: '巨龙斩击', reqLv: 1, type: 'main', dmgMult: 8.0, priority: 7, desc: '[主技能] 巨龙斩击，造成{dmgMult}%攻击力伤害。' },
  en_灾厄: { id: 'en_灾厄', name: '灾厄降临', reqLv: 1, type: 'dot', dmgMult: 0.8, effects: [{ type: 'dot', dur: 4, dps: 1.5, stateName: '灾厄', stateEmoji: '💀' }], priority: 8, desc: '[DoT] 造成{dmgMult}%攻击力伤害并施加灾厄4层。' },
  en_愈合: { id: 'en_愈合', name: '黑暗愈合', reqLv: 1, type: 'instant', dmgMult: 0, effects: [{ type: 'heal', val: 2.0 }], priority: 12, desc: '[治疗] 黑暗愈合，恢复自身生命。' },
  en_蚀箭: { id: 'en_蚀箭', name: '虚空蚀箭', reqLv: 1, type: 'main', dmgMult: 1.5, priority: 4, desc: '[主技能] 虚空蚀箭，造成{dmgMult}%攻击力伤害。' },
  en_血爆: { id: 'en_血爆', name: '血晶爆发', reqLv: 1, type: 'main', dmgMult: 2.8, priority: 5, desc: '[主技能] 血晶爆发，造成{dmgMult}%攻击力伤害。' },
  en_噬咬: { id: 'en_噬咬', name: '虚空噬咬', reqLv: 1, type: 'main', dmgMult: 1.6, effects: [{ type: 'heal', val: 1.5 }], priority: 12, desc: '[主技能] 虚空噬咬，造成{dmgMult}%攻击力伤害并吸取生命。' },
  en_慰言: { id: 'en_慰言', name: '虚空慰言', reqLv: 1, type: 'instant', dmgMult: 2.0, priority: 11, desc: '[瞬发] 虚空慰言，造成{dmgMult}%攻击力伤害。' },
  // ---- Boss ----
  en_炎噬: { id: 'en_炎噬', name: '烈焰噬咬', reqLv: 1, type: 'main', dmgMult: 5.0, priority: 7, desc: '[主技能] 烈焰噬咬，造成{dmgMult}%攻击力伤害。' },
  en_灭杀: { id: 'en_灭杀', name: '湮灭低语', reqLv: 1, type: 'instant', dmgMult: 3.5, priority: 11, desc: '[瞬发] 湮灭低语，造成{dmgMult}%攻击力伤害。' },
  en_献祭: { id: 'en_献祭', name: '灵魂献祭', reqLv: 1, type: 'main', dmgMult: 0, effects: [{ type: 'hp_sacrifice', costPct: 0.5, dmgMult: 20 }], priority: 17, desc: '[终焉][主技能] 献祭当前生命 50%，对敌人造成巨额伤害。' },
  en_虚空领域: { id: 'en_虚空领域', name: '虚空领域', reqLv: 1, type: 'domain', dmgMult: 0, effects: [{ type: 'domain', dur: 5, dps: 5.0, domainType: 'void', stateName: '虚空领域', stateEmoji: '🌌' }], priority: 18, desc: '[终焉][领域] 展开虚空领域，每层造成500%伤害。' },
  en_咏叹调: { id: 'en_咏叹调', name: '终焉咏叹调', reqLv: 1, type: 'main', dmgMult: 6.5, priority: 17, desc: '[终焉][主技能] 终焉咏叹调，造成{dmgMult}%攻击力伤害。' },
  en_法则: { id: 'en_法则', name: '法则解构', reqLv: 1, type: 'debuff', dmgMult: 0, effects: [{ type: 'vuln', val: 1.5, dur: 6 }], priority: 17, desc: '[终焉][Debuff] 法则解构：受击伤害大幅提高6层。' },
  en_魔阵: { id: 'en_魔阵', name: '无限魔阵', reqLv: 1, type: 'buff', dmgMult: 0, effects: [{ type: 'buff', stat: 'versa', val: 50, dur: 8 }], priority: 18, desc: '[终焉][Buff] 无限魔阵：提升共鸣8层。' },
  en_烈焰领域: { id: 'en_烈焰领域', name: '烈焰领域', reqLv: 1, type: 'domain', dmgMult: 0, effects: [{ type: 'domain', dur: 5, dps: 5.0, domainType: 'flame', stateName: '烈焰领域', stateEmoji: '🔥' }], priority: 18, desc: '[终焉][领域] 展开烈焰领域，每层造成500%伤害。' },
};
