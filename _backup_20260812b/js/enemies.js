...
// ---- 敌人独立技能池（2026-08-11 用户定案；2026-08-12 从零重做）----
// 40 个 en_ 技能（机制全新：6 新效果类型；名字不撞玩家；伤害基数 atk/maxhp 不秒杀）；
// reqLv 等级门槛（1/3/6，新手保护：低等级敌人不带高级技能）；
// 敌人无 [终焉] 标记（终焉是玩家技能概念）
export const ENEMY_SKILLS = {
  ...
  en_致命背刺: { id: 'en_致命背刺', name: '致命背刺', reqLv: 1, type: 'main', dmgMult: 4.5, priority: 7, desc: '[主技能] 致命背刺，造成{dmgMult}%攻击力伤害。' }, // R1-B：reqLv 3→1（Lv1-2 刺客零技能）
  ...
  // ---- Boss（深渊领主/时空支配者）----
  en_深渊斩击: { id: 'en_深渊斩击', name: '深渊斩击', reqLv: 1, type: 'main', dmgMult: 4.0, priority: 7, desc: '[主技能] 深渊斩击，造成{dmgMult}%攻击力伤害。' }, // R1-B：5.0→4.0（裸装 Lv6 满血击杀破口）
  ...
  en_深渊裂隙: { id: 'en_深渊裂隙', name: '深渊裂隙', reqLv: 3, type: 'main', dmgMult: 0, effects: [{ type: 'multi_hit', hits: 2, dmgMult: 2.0 }], priority: 7, desc: '[主技能] 深渊裂隙连击 2 段，每段 200% 攻击力伤害。' }, // R1-B：2×2.5→2×2.0
